    ...
    <div class="am-g am-g-fixed">
        <div class="am-u-md-8">
            <c:if test="${fn:length(picRecommendList)>=1}">
                <div id="picrecommenddiv" data-am-widget="slider" class="am-slider am-slider-c3"
                     data-am-slider='{&quot;controlNav&quot;:false}'>
                    <ul class="am-slides">
                        <c:forEach items="${picRecommendList}" var="pic" varStatus="picS">
                            <li>
                                <img src="${base}/attached/picrecommend/${pic.image}"
                                     onerror="javascript:this.src='${base}/attached/picrecommend/picrecommenddefault.jpg'"
                                     alt="pic.title">
                        ...
                        <div class="am-g">
                            <div class="am-u-sm-3">
                                <a class="blog-a-curse" href="${base}/blog/detail/${l.id}">
                                    <img class="am_img animated" alt="${l.title}" src="${base}/images/index/loading.gif"
                                         data-original="${base}/attached/blog/${l.image}">
                                </a>
                            </div>
                            <div class="am-u-sm-9">
                                <div class="blog-header">
                                    <span class="index-label index-label-blog">博客</span>
                                    <a href="${base}/blog/categorySearcher?category=${l.category}"
                                       class="blog-category">${l.categorystr }</a>
                                ...
                                <p class="blog-ext">
                                    ...
                                    <span class="blog-ext-ico"><i
                                            class="am-icon-clock-o blog-ext-ico"></i><fmt:formatDate
                                            value="${l.create_time}" pattern="yyyy-MM-dd"/></span>
									<span class="blog-ext-ico">
                ...
                <c:if test="${empty l.image}">
                    <div class="inner-box blog-img ">
                        ...
                        <p class="blog-ext">
                            ...
                            <span class="blog-ext-ico"><i
                                    class="am-icon-clock-o am-icon-sm blog-ext-ico"></i><fmt:formatDate
                                    value="${l.create_time}" pattern="yyyy-MM-dd"/></span>
							<span class="blog-ext-ico">
                    ...
                    <div id="demo4" class="scroll-img">
                        <ul>
                            <c:forEach items="${videoList}" var="v">
                                <li><a href="${base}/video/detail/${v.id}"
                                       data-am-popover="{content: '${v.title}', trigger: 'hover focus'}"><img
                                        src="${base}/attached/video/s_${v.image}" alt="${v.title}"
                                        onerror="javascript:this.src='${base}/images/video/videoloading.gif'"/></a></li>
                            </c:forEach>
                        </ul>
                    </div>
                </div>
            ...
            <div class="beauty-inner-box ">
                <div class="am-g">
                    <div class="am-u-sm-3">
                        ...
                        <img class="am-radius am_img animated" src="${base}/images/index/loading.gif"
                             data-original="${base}/attached/beauty/s_${i.key}" title="${i.value}"
                ...
                <div class="am-u-sm-9">
                    ...
                    <p class="blog-ext">
                        ...
                        <span class="blog-ext-ico"><i class="am-icon-clock-o  blog-ext-ico"></i><fmt:formatDate
                                value="${bl.create_time}" pattern="yyyy-MM-dd"/></span>
									<span class="blog-ext-ico">
										<i class="am-icon-eye  blog-ext-ico"></i>
										${bl.view}
									</span>
